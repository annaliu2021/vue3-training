    ...
    <nav aria-label="Page navigation example">
        <ul class="pagination justify-content-center">
            <li class="page-item" :class="pages.has_pre ? '' : 'disabled'">
                <a v-if="pages.has_pre" class="page-link" href="#"
                    @click.prevent="goToPage(pages.current_page - 1)">Previous</a>
            ...
            <li class="page-item" :class="pages.has_next ? '' : 'disabled'">
                <a v-if="pages.has_next" class="page-link" href="#"
                    @click.prevent="goToPage(pages.current_page + 1)">Next</a>
